...
## V1.0.1 · 正式上线 🏷️ `v1.0.1`（2026-05-26）
...
| 日期 | 变更 |
|------|------|
| 05-26 | 🏷️ `v1.0.1` tag — 域名 pixbook.top + SSL + Nginx + 真机全链路通过 |
| 05-26 | setup-domain.sh 域名一键脚本 |
| 05-26 | MySQL 认证修复 / PM2 路径修复 / Prisma GRANT 修复 |
| 05-25 | 联系方式升为 Order 硬字段，手机号改可选，表单重排 |
| 05-25 | UI 全面优化：成功页/日历动效/首页/表单分组 |
| 05-25 | setup-env.sh 环境安装脚本，README 三场景部署 |
| 05-25 | deploy.sh 一键部署 + ecosystem.config.js PM2 固化 |
